...
def display():
    ...
    players.append("ik-awais")
    print(f"\nAfter appending ik-awais\n {players}")

    # 2. insert(id, val) ---> add a player at a specofic index
    players.insert(4,"orange")
    print("\nAfter inserting: orange\n",players)
    players.insert(0, "ik-awais")
    print(f"\nAfter inserting ik-awais at index 0\n {players}")

    # 3 remove(val) ---> remove a specific player by value
    players.remove("cyan")
    print("\nAfter removing: cyan\n",players)
    players.remove("ik-awais")
    print(f"\nAfter removing ik-awais\n {players}")
    ...
    print("\nCount of red:\n",reds)
    ikawais = players.count("ik-awais")
    print(f"\nCount of ik-awais: {ikawais}") 
    ...
    'ik-awais' that happened to be on index 0. But it didn't remove 
    ...
    '''
    players.insert(0, "ik-awais")
    print(f"\nBefore removing all 'ik-awais' from the list:\n {players}")
    to_remove = "ik-awais"
    ...
    print(f"\nAfter removing all 'ik-awais' from the list:\n {players}")
